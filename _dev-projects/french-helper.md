...
<div id="api-banner">
  ...
  <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener">Get a free API key at Google AI Studio ↗</a>
</div>
...
<div id="onboarding">
  <div class="onboarding-inner">
    ...
    <div class="tips-box">
      <h3>✦ Tips</h3>
      <ul>
        <li>You need a free <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener" style="color:var(--gold)">Google Gemini API key</a> for translations and chat — no credit card required, generous free tier. Paste it in the banner above, it's stored only in your browser.</li>
...
async function openWordModal(rawWord) {
  ...
  if (!apiKey) {
    ...
    document.getElementById('wm-error').textContent     = 'Add your Gemini API key to get word analysis.';
    return;
  }
...
async function callClaude(messages, systemPrompt = '') {
  // Gemini API — convert from Anthropic message format
    ...
    <div class="footer-col-wrapper">
      <div class="footer-col footer-col-1">
        <ul class="contact-list">
          ...
          <li><a class="u-email" href="/cdn-cgi/l/email-protection#c6a5aaa7b3a2afa3aaa7b4a9b3a5aea386a1aba7afaae8a5a9ab"><span class="__cf_email__" data-cfemail="4c2f202d39282529202d3e23392f24290c2b212d2520622f2321">[email&#160;protected]</span></a></li>
        </ul>
      </div>
      ...
      <div class="footer-col footer-col-3">
        ...
        <a href="https://ko-fi.com/H2H21DRM34" target="_blank"><img height="36" style="border:0px;height:36px;" src="https://s