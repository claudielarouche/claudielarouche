...
function isPastDate(dateString) {
	...
	// Parse the date string in "YYYY-MM-DD" formatlet originalData = []; // Initialize as an empty array
...
function renderTable(data) {
	...
	const filteredData = filterDataByDateAndAreaAndAgeGroup(data, selectedDate, selectedArea, selectedAgeGroup);
...
function filterDataByDateAndAreaAndAgeGroup(data, selectedDate, selectedArea, selectedAgeGroup) {
